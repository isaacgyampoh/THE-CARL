...
namespace TheCarl.Infrastructure.Evidence;
...
/// transaction happened on a phone THE CARL is not installed on. There is deliberately no
...
public sealed class ManualEntryEvidenceSource : ITransactionEvidenceSource
{
    ...
    /// phone THE CARL cannot reach — this is the path that keeps working.
    /// </remarks>
