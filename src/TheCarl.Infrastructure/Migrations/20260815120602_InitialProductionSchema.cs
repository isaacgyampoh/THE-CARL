        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentCash = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentFloat = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FloatBalances", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningCash = table.Column<decimal>(type: "numeric", nullable: false),
                    CashInflow = table.Column<decimal>(type: "numeric", nullable: false),
                    CashOutflow = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncStatus = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    ReconciliationStatus = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsVersion = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_OrganizationId_BranchId_Type_IsAcknowledged_CreatedAt",
                table: "Alerts",
                columns: new[] { "OrganizationId", "BranchId", "Type", "IsAcknowledged", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_OrganizationId_DeviceIdentifier",
                table: "Devices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reconciliations_OrganizationId_BranchId_SessionId",
                table: "Reconciliations",
                columns: new[] { "OrganizationId", "BranchId", "SessionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_OrganizationId_BranchId_OpenedAt",
                table: "Sessions",
                columns: new[] { "OrganizationId", "BranchId", "OpenedAt" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Transactions",
                columns: new[] { "OrganizationId", "BranchId", "TransactionAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_OrganizationId_ProviderReference",
                table: "Transactions",
