...
/// <summary>How a transaction came to Zazi's attention.</summary>
public enum EvidenceSourceType
{
    /// <summary>SMS read on an Android device running Zazi.</summary>
    AndroidSms = 0,
...
/// a claim; a financial transaction is a claim Zazi has accepted into the ledger.
