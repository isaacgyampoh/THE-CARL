...
/** How a transaction came to Zazi's attention. Mirrors the backend enum. */
...
/** Mobile-money networks Zazi recognises in Ghana. */
 ...
 * transaction is a claim Zazi has accepted. Conflating them means a parser failure or a
...
/**
 * A transaction Zazi has accepted locally and will submit to the server.
 *
