...
import app.thecarl.core.domain.security.DatabaseKeyProvider
import net.sqlcipher.database.SupportFactory

/**
 * THE CARL's local database.
 *
...
@Database(
    ...
    version = CarlDatabase.VERSION,
    exportSchema = true
)
abstract class CarlDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        ): CarlDatabase = build(context, SupportFactory(keyProvider.databaseKey()))
        ...
        fun build(
            ...
            Room.databaseBuilder(context, CarlDatabase::class.java, DATABASE_NAME)
                ...
                .addMigrations(*CarlDatabaseMigrations.ALL)
                .build()
    }
}
