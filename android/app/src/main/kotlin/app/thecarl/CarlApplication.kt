 ...
 */
class CarlApplication : Application(), Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        applicationScope.launch {
            ...
            if (state is SessionState.Active) {
                SyncWorker.enqueue(this@CarlApplication)
            }
        }
    }
     ...
     *
     * <p>Provided rather than left to the default initialiser so [CarlWorkerFactory] can
     * inject the sync engine. The container is constructed in [onCreate] before WorkManager
     * first asks for this.</p>
     */
    override val workManagerConfiguration: Configuration
        get() = Configuration.Builder()
            .setWorkerFactory(CarlWorkerFactory(container.syncEngine))
            .build()
}
